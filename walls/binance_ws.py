"""WebSocket subscriber for Binance public depth streams.

Each :class:`DepthStream` runs an independent connection (one per symbol). This
keeps reconnect handling simple and isolates symbols from each other — if one
